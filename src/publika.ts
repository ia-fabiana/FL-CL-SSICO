...
export const PUBLIKA_MODULES: PublikaModule[] = [
  {
    ...
    benefit: 'Usado antes do AL - Aquecimento de Inscritos para alinhar branding, copy base e indicadores do funil.',
    credits: 0,
    status: 'available',
  ...
  },
  {
    ...
    benefit: 'Vira grade oficial do aquecimento (21 dias) com entregas alinhadas ao AL - Aquecimento de Inscritos.',
    credits: 1,
    status: 'available',
  ...
  },
  {
    ...
    benefit: 'Garante cadência das notificações SNA e pauta PEC/REP no AL - Aquecimento de Inscritos.',
    credits: 0,
    status: 'available',

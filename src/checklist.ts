...
const BLOCK_DEFINITIONS: Array<{
  ...
  { id: 'B3', title: 'Construção de Lista (CLI)', description: 'Landing, automações e metas de CPL prontos' },
  { id: 'B4', title: 'Aquecimento', description: 'Calendário 21 dias + blocos PEC/REP/Conteúdo' },

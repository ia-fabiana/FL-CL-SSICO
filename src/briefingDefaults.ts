...
Novidade - novidade real do metodo ou abordagem.`,
  ...
  expertInstagramHandle: '@iafabianaoficial',
  expertInstagramUrl: 'https://www.instagram.com/iafabianaoficial/',
  expertFacebookUrl: '',
  expertYoutubeUrl: '',
  expertLinkInBio: 'https://wa.me/5500000000000',
  expertPhotoReferenceUrl: '',
  expertLookGuide: 'Blazer claro com camisa neutra, imagem elegante e profissional.',
  expertLookReferenceUrl: '',
  expertEnvironmentGuide: 'Ambiente de salão premium, limpo, iluminado e sofisticado.',
  expertEnvironmentReferenceUrl: '',
  expertArtDirection: 'Luz natural suave, enquadramento meio corpo, expressão confiante e acolhedora.',
...
Eu sentei para estudar, busquei uma especialização em digital business, e isso me mostrou que o profissional da beleza precisa estar focado na cliente, fazendo o que sabe fazer melhor. Um universo de conhecimento se abriu: se você não sabe o que pedir, se não sabe como direcionar, a IA entrega qualquer coisa. Quando você aprende a usar, ela vira velocidade, clareza e produtividade. Eu precisava de um jeito mais rápido e produtivo porque, do jeito antigo, era muito tempo para pouco resultado.

Eu me esforçava, cobrava o time para gerar conteúdo, fazia antes e depois, pensava na foto, na legenda, pagava várias ferramentas de edição. Era gasto excessivo e pouco retorno. Produzir um único conteúdo drenava minha energia enquanto eu ainda precisava lutar para ser vista. A cliente agora está com o olhar na pequena tela: Facebook, Instagram, TikTok. O que fazíamos antes não era mais suficiente. As pessoas passaram a pedir a rede social do profissional para ver o trabalho antes de agendar.

Passei a pedir fotos e posts, mas a maioria não fazia ou a qualidade era baixa. Nem sempre a cliente autorizava fotos e ninguém queria usar a folga para gerar conteúdo. Tentei parceria com agência de modelo; eram horas preparando cabelo, maquiagem, fotografia e, mesmo assim, os profissionais queriam estar atendendo clientes pagantes. Chegou uma fase em que postar era tão difícil que eu parei. Eu abria o Instagram, olhava a foto e pensava: "Não tá bom o suficiente", "ninguém vai ligar pra isso". Bate o desânimo porque você trabalha o dia inteiro e ainda precisa ter boas ideias, planejar, fotografar, postar e manter frequência.
...
A virada veio quando entendi que algo tinha que mudar. Se eu queria seguir relevante, precisava de clareza e um método. A IA não substitui o talento, mas me deu fôlego para manter consistência. Hoje eu uso a IA Fabiana para transformar briefing em planejamento real, garantir que cada conteúdo tenha propósito e manter o foco no que sempre importou: atender com excelência enquanto a máquina cuida da velocidade.`,
  ...
  anchorPrice: 'R$ 3.497 (mentoria individual + acompanhamento in loco)',
  guarantee: 'Garantia 7/30 — 7 dias incondicional + 30 dias condicional após envio das tarefas.',
  bonuses:
    '1) Kit de prompts GPT da Beleza. 2) Biblioteca de aulas gravadas. 3) Comunidade fechada com calendário PEC/REP para salões.',
  paymentMethods: 'Cartão em até 12×, PIX com 10% off, boleto PJ programado.',
  scarcity: '50 vagas por turma e fechamento em 26/04/2026 ou antes se a lista VIP chegar a 300 salões.',
  launchDate: '2026-04-15',
  offerDetails:
    '6 módulos ao vivo + consultorias em grupo, plantões semanais, hub de ferramentas e suporte via WhatsApp corporativo.',
};
